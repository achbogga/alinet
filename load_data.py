...
def convert_to_grey_scale(source, dest, img_rows, img_cols):
	...
	#dest = 'CKplus/dataset/processed_alinet'
...
def prepare_data(img_rows=224, img_cols=224, img_chs=3, out_put_classes=7, img_src='CKplus/dataset/processed_alinet', label_src='CKplus/dataset/labels/emotion_labels.txt', asGray=False, face_detection_xml ="opencv2_data/haarcascades/haarcascade_frontalface_default.xml"):
