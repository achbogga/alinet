...
desc = "_False_"+str(img_rows)+"_"+str(img_cols)+"_"+str(img_chs)+".npy"


# In[ ]:

train_network(augment_data=True, nb_epochs=200, batch_size=32, loss='categorical_crossentropy', optim = 'adam', X_train_file = "X_train"+desc, X_test_file = "X_test"+desc, Y_train_file = "Y_train"+desc, Y_test_file = "Y_test"+desc, model_from = model, logger=True, lr_reduce=True, min_lr = 0.0001, metrics = ['accuracy'])
